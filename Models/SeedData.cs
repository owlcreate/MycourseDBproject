...
//ADD THE MISSING USING STATEMENT HERE
...
namespace nscccoursemap_matchacode.Models
{
    public static class SeedData
    {
        ...
        {
            using (var context = new NsccCourseMapDbContext(
                serviceProvider.GetRequiredService<
                    DbContextOptions<NsccCourseMapDbContext>>()))
            {
                // Look for any diplomas.
                // If there are no diplomas in the table,
                // we'll assume that the database has not been seeded
    	...
    	private static void SeedTheDatabase(NsccCourseMapDbContext context) 
    	{
        ...
        #region SEED INSTRUCTORS
                    ...
                    context.Instructors.AddRange(
                        ...
                        new Instructor { FirstName="Michael",    LastName="McLeod" },
